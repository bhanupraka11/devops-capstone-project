...
This project is a customer accounts microservice for an e-commerce application, 
built as part of the IBM DevOps Capstone Project. It provides RESTful API 
endpoints to create, read, update, delete, and list customer account data. 
The service is containerized using Docker and deployed to Kubernetes.
